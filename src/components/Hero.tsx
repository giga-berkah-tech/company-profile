        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              PT. Giga Berkah Teknologi offers high-quality IT solutions
              supported by a team of experienced experts. We prioritize customer
              satisfaction and strive to provide the best possible service. With
              our IT solutions, your business can operate efficiently and
              effectively.
            </p>

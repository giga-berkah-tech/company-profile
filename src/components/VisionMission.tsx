...
const VisionMission = () => {
  return (
    <>
        <Container>
            <div className='flex flex-row w-full max-w-7xl p-2 mx-auto'>
                <div className='w-1/2 bg-indigo-500 rounded-lg p-10'>
                ...
                <div className='w-1/2 bg-gray-100 rounded-lg p-10'>
